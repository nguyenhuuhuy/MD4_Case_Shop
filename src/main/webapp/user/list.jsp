            ...
            <table class="table table-striped table-hover text-center">
                ...
                <c:forEach items='${requestScope["listUser"]}' var="user">
                    <tr align="center">
                        ...
                        <td>${user.roleSet}</td>
                        <td>
                            <a href="user?action=edit&id=${user.id}" type="button" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                        </td>
                        <td>
                            <a href="user?action=delete&id=${user.id}" type="button" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
